...
for annot in annotations['annotations']:
    ...
    # The images are stored in 000000xxxxx format- adding trailing zeros
...
# Function to load the image and preprocess it as per the requirements of InceptionV3
...
cap_vector = tf.keras.preprocessing.sequence.pad_sequences(train_seqs, padding='post',maxlen=calc_max_length(train_seqs))
...
#The attention feature shape will be same as the 
...
# Load the numpy files each numpy file has a shape of 64x2048
...
checkpoint_path = "./checkpoints/without_sentiment_inceptionV3"
...
def evaluate(image):
    ...
    # run resize for inception v3 feed forward
